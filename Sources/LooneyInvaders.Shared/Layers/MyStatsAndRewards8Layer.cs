...
namespace LooneyInvaders.Layers
{
    public class MyStatsAndRewards8Layer : CCLayerColorExt
    {
        ...
        public MyStatsAndRewards8Layer()
        {
            ...
            this.AddImage(191, 430, "UI/My-stats-&-rewards-south-korea-text.png");
            if (Player.Instance.GetSavedCountries(BATTLEGROUNDS.SOUTH_KOREA) > 0) this.AddImage(530, 432, "UI/My-stats-&-rewards-country-defended-symbol.png"); else this.AddImage(530, 432, "UI/My-stats-&-rewards-country-not-defended-symbol.png");

            this.AddImage(191, 368, "UI/My-stats-&-rewards-israel-text.png");
            if (Player.Instance.GetSavedCountries(BATTLEGROUNDS.ISRAEL) > 0) this.AddImage(530, 370, "UI/My-stats-&-rewards-country-defended-symbol.png"); else this.AddImage(530, 370, "UI/My-stats-&-rewards-country-not-defended-symbol.png");

            this.AddImage(191, 306, "UI/My-stats-&-rewards-japan-text.png");
            if (Player.Instance.GetSavedCountries(BATTLEGROUNDS.JAPAN) > 0) this.AddImage(530, 308, "UI/My-stats-&-rewards-country-defended-symbol.png"); else this.AddImage(530, 308, "UI/My-stats-&-rewards-country-not-defended-symbol.png");

            this.AddImage(191, 244, "UI/My-stats-&-rewards-great-britain-text.png");
            if (Player.Instance.GetSavedCountries(BATTLEGROUNDS.GREAT_BRITAIN) > 0) this.AddImage(530, 246, "UI/My-stats-&-rewards-country-defended-symbol.png"); else this.AddImage(530, 246, "UI/My-stats-&-rewards-country-not-defended-symbol.png");

            this.AddImage(191, 182, "UI/My-stats-&-rewards-united-states-text.png");
            if (Player.Instance.GetSavedCountries(BATTLEGROUNDS.UNITED_STATES) > 0) this.AddImage(530, 184, "UI/My-stats-&-rewards-country-defended-symbol.png"); else this.AddImage(530, 184, "UI/My-stats-&-rewards-country-not-defended-symbol.png");
            ...
            {
                this.AddImage(191, 95, "UI/My-stats-&-rewards-reward-locked.png");
        ...
        private async void getRewardCode()
        {
            ...
            await Task.Run(() => {
                code = RewardsManager.GetEnemyRewardCode(ENEMIES.KIM);
