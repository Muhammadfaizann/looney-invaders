...
extern void *mono_aot_module_LooneyInvadersiOS_info;
...
extern void *mono_aot_module_App42_CSHARP_SDK_2_3_info;
...
{
	mono_aot_register_module (mono_aot_module_LooneyInvadersiOS_info);
	...
	mono_aot_register_module (mono_aot_module_App42_CSHARP_SDK_2_3_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("CocosSharp.dll", &exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "LooneyInvadersiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
